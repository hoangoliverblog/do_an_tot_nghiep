    ...
    <div class="row col-md-8">
        <div class="modal-body">
            ...
            <form action="{{route('staff.update',[$staff->id])}}" method="post" enctype="multipart/form-data">
              ...
              <input type="text" class="form-control" name="name" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$staff->name}}">
                @error('name')
                  {{$message}}
                @enderror
              </div>
              ...
              <div class="form-group">
                  ...
                  @error('address')
                    {{$message}}
                  @enderror
                  <input type="text" class="form-control" name="address" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$staff->address}}">
                </div>
                <div class="form-group">
                  ...
                  @error('phone')
                    {{$message}}
                  @enderror
                  <input type="text" class="form-control" name="phone" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$staff->phone}}">
                </div>
                <div class="form-group">
                  ...
                  <select name="gioitinh" id="gioitinh" class="form-control" id="exampleFormControlSelect1">
                    <option selected="selected" value="{{$staff->gioitinh}}">{{$staff->gioitinh}}</option>
                ...
                <div class="form-group">
                  ...
                  <select name="status" id="status" class="form-control" id="exampleFormControlSelect1">
                    <option selected="selected" value="{{$staff->status}}">{{$staff->status}}</option>
