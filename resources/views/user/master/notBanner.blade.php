        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xl-6">
                    ...
                    <div style="padding : 1rem 0.1rem 0.3rem 0.1rem;margin-left: 15rem">
                        ...
                        <input type="submit" value="Submit" style="background-color:transparent;height:44px;display:inline-block;border: 1px solid rgb(67, 201, 67);padding:0.1rem 1.3rem;margin-left:-0.3rem">
                        </form>
                    </div>
                </div>
            </div>
...
function sum(){
    // inputProductSoluong = document.getElementById('productsoluong');
    input = document.getElementById('soluong');
    lastUpdateValue = Number(input.value) + 1;
    // if(input.value >= inputProductSoluong.value)
    // {
    //     lastUpdateValue = inputProductSoluong.value ;
    // }
    return input.value = lastUpdateValue;
